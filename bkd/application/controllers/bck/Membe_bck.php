				...
				if ($uid && $uid != ''
					...
					if (is_array($memberdata) && count($memberdata)>0 && isset($memberdata['Id_pengguna'])) {
						...
						if($post['foto_file_hidden']!=''){	
							...
							$accessKeyId = "LTAIJbwb8rmv5ptU";
							$accessKeySecret = "CSwic1up6VGQtlg4bp2DLQc731n5Re";
							// This example uses endpoint China (Hangzhou). Specify the actual endpoint based on your requirements.
							$endpoint = "https://oss-ap-southeast-5.aliyuncs.com";
							// Bucket name
							$bucket= "bkdana";
							// Object name
							$object = $output_file_with_extension;
							...
							try{
								...
								$ossClient->deleteObject($bucket,$post['old_foto']);
