...
class Payment_test extends CI_Controller {
	...
	var $set_order_id = '10293866'; //hanya untuk testing aja
	...
	**********************************************/
	...
	public function notification()
	{
		...
		$upcheckout['pay_date'] = date('Y-m-d H:i:s');
		$this->Content_model->insert_payment_log($upcheckout);
	}
