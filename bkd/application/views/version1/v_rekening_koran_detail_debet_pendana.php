                        ...
                        <div class="content">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                                ...
                                                <tr>
                                                 ...
                                                 <tr>
                                                   <td><span>Nama Peminjam</span> <a href="<?php echo $link_detail; ?>" class="text-warning"
                                                     data-toggle="tooltip" data-placement="right" data-original-title=""><?php echo $walletkoran['nama_peminjam']; ?> <i class="fas fa-user-circle"></i></a></td>
                                                </tr>
                                                <?php
                                        $total_pendapatan = $log_transaksi['ltp_jml_angsuran'] - ($log_transaksi['ltp_jml_angsuran']*$log_transaksi['ltp_product_pph']);
                                                ?>
                                                 <tr>
                                                <td><span>Jumlah Saldo diterima</span> 
                                                    <?php echo number_format($log_transaksi['ltp_jml_angsuran']) .' - PPH '.$log_transaksi['ltp_product_pph'].'% = '. number_format($total_pendapatan); ?> IDR
                                                    <br>
                                                  </td>
                                                <td></td>
                                            </tr>
                                                <tr>
                                                    <td> <?php echo $walletkoran['Notes'].' '.'senilai'.' ';?> IDR&nbsp;<?php echo $walletkoran['Amount']; ?></td>
                                                </tr>
                                    ...
                                    <?php
                                    $ltpangsuran = $log_transaksi['ltp_jml_angsuran'];
                                    $ltplamaangsuran = $log_transaksi['ltp_lama_angsuran'];
                                    $totalangsuran = $ltpangsuran * $ltplamaangsuran;

                                    ?>
                                     <div class="panel panel-default">
                                        <div class="panel-heading">Repayment</div>
                                        <div class="panel-body">
                                            <table class="table-custom">
                                                <tr>
                                                    <td><span>Pokok Pinjaman</span> IDR&nbsp;<?php echo $log_transaksi['ltp_pokok_cicilan'];?></td>
                                                </tr>
                                                <tr>
                                                    <td><span>Bunga</span> IDR&nbsp;<?php echo $log_transaksi['ltp_bunga_cicilan']; ?></td>
                                                </tr>
                                                <tr>
                                                    <td><span>Jumlah Angsuran</span> IDR&nbsp;<?php echo $log_transaksi['ltp_jml_angsuran']; ?></td>
                                                </tr>
                                                <tr>
                                                    <td><span>Total Repayment</span> IDR&nbsp;<?php echo $totalangsuran; ?></td>
                                                </tr>
