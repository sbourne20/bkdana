                            ...
                            <div class="panels">
                                <div class="panel" id="panel1">
                                    ...
                                    <div class="panel__content">
                                        <div class="row">
                                            <div class="col-sm-9">
                                                <form id="form_name1" name="form_name1" method="post" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <p class="form-control-static" id="m_jumlah_pinjam"></p>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-5 control-label">Tenor</label>
                        <div class="col-sm-6">
