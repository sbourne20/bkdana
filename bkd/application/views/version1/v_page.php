<?php 
	if(strtolower($datapage['p_title']) == 'pendanaan')
		$this->load->view($this->config->item('template_frontend').'/'.'v_page_pendanaan'); 
	else if((strtolower($datapage['p_title']) == 'pinjaman'))
		$this->load->view($this->config->item('template_frontend').'/'.'v_page_pinjaman'); 
	else{
?>
	<!-- Header -->
	<header>
