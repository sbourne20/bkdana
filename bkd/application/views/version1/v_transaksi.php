                    ...
                    <div class="box plain right">
                        <div class="content">
                            ...
                            <div class="alert alert-info">
                                ...
                                Apabila crowd funding telah melewati batas akhir (14 hari) dan telah mencapai 80%, dana akan tetap di disburse.
                            </div>
                            <?php } ?>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <div class="input-group grouping-search">
                                        <form method="GET" action="<?php echo site_url('transaksi/search'); ?>">
                                            <input type="text" class="form-control" placeholder="Pencarian No.Transaksi" name="q" required="required">
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($list_transaksi as $tra) { 
                                                    ...
                                                    }else if ($tra['transaksi_status'] == 'complete') {
