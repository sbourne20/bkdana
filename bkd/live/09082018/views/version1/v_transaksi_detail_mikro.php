                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">Detail</div>
                                    <div class="panel-body">
                                        ...
                                        <?php 
                                        // status bayar
                                        if ( $transaksi['Master_loan_status'] == 'approve' && ($transaksi['date_close'] == '0000-00-00' OR $transaksi['date_close'] == '0000-00-00 00:00:00' OR $transaksi['date_close'] == '') ) {
                                            $status_bayar = 'Dalam Cicilan';
                                        ...
                                        <ul class="cbp_tmtimeline">
                                            ...
                                            <li>
                                                ...
                                                <div class="cbp_tmlabel">
                                                    ...
                                                    <p><?php echo number_format($jml_cicilan, 2); ?> IDR</p>
                ...
                <div class="section-payment-process">    
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="bill">Tagihan : <?php echo number_format($jml_cicilan, 2); ?> IDR</div>
                            <br><br>
