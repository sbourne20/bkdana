                ...
                <div class="col-sm-9">
                    <div class="box plain right">
                        <div class="content">
                            ...
                            <a data-toggle="modal" data-target="#modalTransferManual" href="#" title="Transfer Manual">
                                        ...
                                        <div class="payment-wrapp">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-10 col-xs-6 no-padding">
                                                    <h5 class="title">Transfer Manual</h5>
                                                    <small class="text-muted">Top Up via Transfer manual (Verifikasi Manual)</small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <a data-toggle="modal" data-target="#modalTransferVirtual" ref="#" title="Virtual Account">
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        <div class="payment-wrapp">
                                            <div class="row">
