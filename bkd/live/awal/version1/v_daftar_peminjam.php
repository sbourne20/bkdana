                        ...
                        <div class="content">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <select class="form-control sort" id="idSort">
                                        <option disabled selected>- Filter by -</option>
                                        <option value="0">Pinjaman Keseluruhan</option>
                                        <option value="1">Pinjaman Mikro</option>
                                        <option value="2">Pinjaman Usaha</option>
                                    </select> 
                                    &nbsp; 
                                        ...
                                        <table class="table table-hover link">
                                            ...
                                            <tbody>
                                                ...
                                                <?php foreach ($list_transaksi as $tra) {  
                                                    ...
                                                    $slot = round($tra['jml_kredit']/$tra['total_approve']*100);
                                                ?>
                                                ...
                                                <tr onclick="document.location='<?php echo $link_detail; ?>'" title="Klik Detail Peminjam">
                                                    ...
                                                    <td><?php echo $tra['Loan_term']; ?> Bulan</td>
                                                </tr>
                                                <?php } 
                                                }else{ ?>
