        ...
        <div class="section-why">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    ...
                    <p>BKDana diawasi OJK, bekerjasama dengan asuransi kredit & borrower yang telah diverifikasi.</p>
                </div>
                <div class="col-sm-4">
                    <div class="img-wrapp">
                    ...
                    <p>Bunga investasi jauh diatas bunga deposito dan besarnya tergantung sektor dan rating Peminjam.</p>
                </div>
            </div>
            <br>
            <div class="row">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="video-wrapp">
                        <video id="video1" poster="https://www.bkdana.com/assets/video/video.jpg">
                            <source src="https://www.bkdana.com/assets/video/video.mp4" type="video/mp4" />
                            <source src="https://www.bkdana.com/assets/video/video.webm" type="video/webm" />
                            <source src="https://www.bkdana.com/assets/video/video.ogv" type="video/ogg" />
...
<div class="container">
    <div class="wrapper-content">
        ...
        <div class="section-fundrising">          
                ...
                <div class="row">
                        ...
                        <a href="#">
                            <div class="item-wrapp">
                                <div class="product-type">
                                    <div class="color-wrapp blue">A1</div>
                                </div>
                                <ul class="product">
                    ...
                    <div class="col-sm-4 drag-this-up drag-up">
                        <a href="#">
                            <div class="item-wrapp">
                                <div class="product-type">
                                    <div class="color-wrapp soft-blue">B1</div>
                                </div>
                                <ul class="product">
                    ...
                    <div class="col-sm-4 drag-this-up drag-up">
                        <a href="#">
                            <div class="item-wrapp">
                                <div class="product-type">
                                    <div class="color-wrapp soft-green">C2</div>
                                </div>
                                <ul class="product">
            ...
            <a href="#" class="btn btn-blue">Selengkapnya <i class="fas fa-play"></i></a>
        </div>
