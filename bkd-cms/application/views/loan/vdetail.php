		...
		<tr>
			...
			<td>
				...
				switch ($data['Master_loan_status']) {
					case 'approve':
						$html = '<span class="label label-primary">'.$data['Master_loan_status'].'</span>';
						break;
					case 'lunas':
						$html = '<span class="label label-success">'.$data['Master_loan_status'].'</span>';
						break;
					case 'reject':
						$html = '<span class="label label-danger">'.$data['Master_loan_status'].'</span>';
						break;
					case 'complete':
					...
					default:
						$html = '<span class="label label-default">'.$data['Master_loan_status'].'</span>';
						break;
				}
				echo $html; 
				?>				
