                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal form-validation" method="POST" id="formID">
                            <input type="hidden" name="uid" class="form-control" value="<?php echo $EDIT['id_system_user']; ?>">
                            <input type="hidden" name="username" value="<?php echo $EDIT['username']; ?>">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Username</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" value="<?php echo $EDIT['username']; ?>" disabled="disabled">
                                </div>
                            </div>
