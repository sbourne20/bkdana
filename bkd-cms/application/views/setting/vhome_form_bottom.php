	            ...
	            <div class="panel-body">
	                ...
	                <form class="form-horizontal bucket-form" method="post" enctype="multipart/form-data" id="formID" name="formID">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <textarea id="home_1" name="home_1" class="form-control" rows="5"><?php echo htmlspecialchars_decode($EDIT['home_14']); ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-2" style="padding-top:50px !important;">Home Bottom Right</label>
                            <div class="col-md-8">
                                <textarea id="home_2" name="home_2" class="form-control" rows="5"><?php echo htmlspecialchars_decode($EDIT['home_15']); ?></textarea>
                            </div>
                        </div>
