	            ...
	            <div class="panel-body">
	                ...
	                <form class="form-horizontal bucket-form" method="post" enctype="multipart/form-data" id="formID" name="formID">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <textarea id="home_1" name="home_1" class="form-control" rows="5"><?php echo htmlspecialchars_decode($EDIT['home_1']); ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-2" style="padding-top:50px !important;">Home 2</label>
                            <div class="col-md-8">
                                <textarea id="home_2" name="home_2" class="form-control" rows="5"><?php echo htmlspecialchars_decode($EDIT['home_2']); ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-2" style="padding-top:50px !important;">Home 3</label>
                            <div class="col-md-8">
                                <textarea id="home_3" name="home_3" class="form-control" rows="5"><?php echo htmlspecialchars_decode($EDIT['home_3']); ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-2" style="padding-top:50px !important;">Home 4</label>
                            <div class="col-md-8">
                                <textarea id="home_4" name="home_4" class="form-control" rows="5"><?php echo htmlspecialchars_decode($EDIT['home_4']); ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-2" style="padding-top:50px !important;">Home 5</label>
                            <div class="col-md-8">
                                <textarea id="home_5" name="home_5" class="form-control" rows="5"><?php echo htmlspecialchars_decode($EDIT['home_5']); ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-2" style="padding-top:50px !important;">Home 6</label>
                            <div class="col-md-8">
                                <textarea id="home_6" name="home_6" class="form-control" rows="5"><?php echo htmlspecialchars_decode($EDIT['home_6']); ?></textarea>
                            </div>
                        </div>
