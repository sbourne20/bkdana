...
<div class="col-md-12">
	<div style="text-align: center !important;">
		...
		<h4>PERJANJIAN PINJAMAN No: PKS-<?php echo $ordercode; ?> Tertanggal <?php echo $tgl_order; ?></h4>
		<p>antara</p>
	...
	<ol start="2">
	<li><strong>PT BERKAH KELOLA DANA</strong>, suatu perusahaan yang didirikan berdasarkan hukum Negara Republik Indonesia, beralamat di BKD BUILDING, Jl. Guntur 45 Setiabudi Kuningan, Jakarta Selatan 12980, Indonesia, yang dalam hal ini diwakili oleh [-] dalam kedudukannya selaku Direktur yang dalam hal ini bertindak selaku penerima kuasa dari pemberi pinjaman berdasarkan: 
		<ol>
