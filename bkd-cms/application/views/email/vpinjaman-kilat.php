...
<div class="col-md-12">
	<div style="text-align: center !important;">
		...
		<h3>PERJANJIAN PINJAMAN No: PKS-<?php echo $ordercode; ?></h3>
	</div>
	<hr>
	...
	<strong>BAHWA:</strong>
	<ol>
		<li>Penerima Pinjaman memiliki keinginan untuk meminjam dana sejumlah maksimum Rp <?php echo number_format($jml_uang); ?> dari Pemberi Pinjaman.</li>
	...
	<p>
	OLEH KARENA ITU, Para Pihak setuju untuk mengadakan Perjanjian Pinjaman ini berdasarkan syaratsyarat dan ketentuan-ketentuan berikut:
	</p>
	...
	<ol>
		<li><p><strong>DEFINISI DAN INTERPRETASI</strong></p>
			...
			<p><strong>“Fasilitas Pinjaman”</strong> adalah fasilitas pinjaman yang diberikan oleh Pemberi Pinjaman melalui BKDana kepada Penerima Pinjaman sebesar Rp <?php echo number_format($jml_uang); ?>; </p>
		...
		<li><p><strong>PENYEDIAAN FASILITAS PINJAMAN DAN TUJUAN PENGGUNAAN FASILITAS PINJAMAN</strong></p>
			<p>Dengan tunduk pada ketentuan-ketentuan dari Perjanjian Pinjaman ini dan yang terdapat dalam Situs termasuk Syarat dan Ketentuan Umum, Pemberi Pinjaman telah setuju untuk menyediakan suatu Fasilitas Pinjaman dalam jumlah sebesar Rp <?php echo number_format($jml_uang); ?>.</p>
		</li>
