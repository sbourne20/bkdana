...
class Transaction extends CI_Controller {
	...
	function index()
	{
		...
		$output['PAGE_TITLE'] = 'Transaction';

		$mainData['top_css']   = '';
		$mainData['top_js']    = '';
		$mainData['bottom_js'] = '';
		$mainData['bottom_js'] .= add_js('js/data/transaction.js');

		$mainData['mainContent']  = $this->load->view('transaction/vlist', $output, true);
	...
	function json()
	{			
		$data = $this->Transaction_model->get_all_dt();
		print_r($data);
	}
