  ...
  (function() {    
    ...
    var dataTable = $('#dynamic-table').dataTable( {
        ...
        "bServerSide" : true,
        "bStateSave"  : true,
        "sAjaxSource" : baseURL + "loan/json",
        "columns": [
          { "data": "Master_loan_id" },
          { "data": "Master_loan_id" },
          { "data": "Nama_pengguna" },
          { "data": "product_title", "sClass": "hidden-xs" },
          { "data": function ( data, type, full, meta ) {return 'Rp ' + formatMoney(data.Jml_permohonan_pinjaman,0,'.',',');} },
          { "data": function ( data, type, full, meta ) {return 'Rp ' + formatMoney(data.Jml_permohonan_pinjaman_disetujui,0,'.',',');} },
          { "data": function ( data, type, full, meta ) {return garing_date_format(data.Tgl_permohonan_pinjaman);} },
          ...
          { "data" : function ( data, type, full, meta ) {
             var loan_status = data.Master_loan_status;
              if (loan_status=='approve' || loan_status=='lunas' || loan_status=='expired') {
...
function delete_(id) {
  var c= confirm("Are you sure will delete this Loan?");
  if(c==true){
...
function approve_(id) {
  var c= confirm("Approve this Loan?");
  if(c==true){
...
function reject_(id) {
  var c= confirm("Reject this Loan?");
  if(c==true){
